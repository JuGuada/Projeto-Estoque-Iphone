...
export default function Login(){
 ...
 return <div className={styles.container}>
  <div className={styles.left}><img className={styles.image} src="/imagens/login.jpg" alt="Tecnologia e pessoas conectadas"/><div className={styles.imageShade}/><div className={styles.overlay}><h1>Tecnologia<br/>que conecta pessoas.</h1><p>Gerencie produtos, vendas e estoque<br/>com preciṣo, seguran̤a e<br/>experi̻ncia premium.</p></div></div>
  <div className={styles.right}><form className={styles.form} onSubmit={entrar}><h2>BEM-VINDO</h2><span>Acesse sua conta para continuar</span>
   ...
   <p className={styles.signupPrompt}>Ṇo tem uma conta? <Link to="/cadastrar">Cadastre-se</Link></p>
   <small>Protegido com seguran̤a empresarial.</small>
  </form></div>
 </div>;
}
